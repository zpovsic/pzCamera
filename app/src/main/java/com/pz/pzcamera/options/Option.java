package com.pz.pzcamera.options;
...
public abstract class Option<T> {
    ...
    private static abstract class OverlayOption extends Option<Boolean> {
        ...
        public Boolean get(@NonNull CameraView view) {
            ...
            switch (target) {
                case PREVIEW:
                    return params.drawOnPreview;
                case PICTURE_SNAPSHOT:
                    return params.drawOnPictureSnapshot;
                case VIDEO_SNAPSHOT:
                    return params.drawOnVideoSnapshot;
            }
            return false;
        }
        ...
        public void set(@NonNull CameraView view, @NonNull Boolean value) {
            ...
            switch (target) {
                case PREVIEW:
                    params.drawOnPreview = value;
                    break;
                case PICTURE_SNAPSHOT:
                    params.drawOnPictureSnapshot = value;
                    break;
                case VIDEO_SNAPSHOT:
                    params.drawOnVideoSnapshot = value;
                    break;
            }
